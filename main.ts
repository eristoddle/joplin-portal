import { addIcon, Plugin, Notice, WorkspaceLeaf } from 'obsidian';
...
export default class JoplinPortalPlugin extends Plugin {
	// Icon constants
	private static readonly JOPLIN_ICON_ID = 'joplin-icon';
	private static readonly JOPLIN_ICON_SVG = `<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
	...
	async onload() {
		...
		this.addRibbonIcon(JoplinPortalPlugin.JOPLIN_ICON_ID, 'Open Joplin Portal', () => {
			this.activateView();
		});
	...
	private registerJoplinIcon(): void {
		try {
			addIcon(JoplinPortalPlugin.JOPLIN_ICON_ID, JoplinPortalPlugin.JOPLIN_ICON_SVG);
